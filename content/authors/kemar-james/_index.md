...
- icon: envelope
  icon_pack: fas
  link: 'mailto:kkj7854@rit.edu'  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
...
- icon: github
  icon_pack: fab
  link: https://github.com/k3mar
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/kemar-james-6b196a6b/
# Link to a PDF of your resume/CV from the About widget.
# To enable, copy your resume/CV to `static/files/cv.pdf` and uncomment the lines below.
- icon: cv
  icon_pack: ai
  link: files/SE_MS_Kemar_James_Resume_RIT.pdf
