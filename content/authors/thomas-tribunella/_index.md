...
- icon: github
  icon_pack: fab
  link: https://github.com/tjtiv
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/thomas-tribunella-4416a8ba/

# Link to a PDF of your resume/CV from the About widget.
# To enable, copy your resume/CV to `static/files/cv.pdf` and uncomment the lines below.
- icon: cv
  icon_pack: ai
  link: files/Thomas_Tribunella-Resume-2021_03_30.pdf
